...
namespace SmallTricks
{
    static class ExtentionMethods
    {
        ...
        {
            archetype.LocalizedName = Helpers.CreateString($"{archetype.name}.Name", description);
        }

        public static void SetDescription(this BlueprintArchetype archetype, string description)
        {
            archetype.LocalizedDescription = Helpers.CreateString($"{archetype.name}.Description", description);
        }

        public static void SetName(this BlueprintItem item, string description)
        {
            item.m_DisplayNameText = Helpers.CreateString($"{item.name}.Name", description);
        }

        public static void SetDescription(this BlueprintItem item, string description)
        {
            item.m_DescriptionText = Helpers.CreateString($"{item.name}.Description", description);
        }
        ...
        {
            enchantment.m_Description = Helpers.CreateString($"{enchantment.name}.Description", description);
        }
